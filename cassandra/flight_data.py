...
airlines = ["American Airlines", "Delta Airlines", "Alaska", "Aeromexico", "Volaris", "Viva Aerobus", "Aero Calafia Airlines", "MagniCharters", "Southwest Airlines"]
airports = ["PDX", "GDL", "SJC", "LAX", "JFK", "SJD", "AIFA", "AICM", "PHX"]
...
transits = ["Car rental"] #["Airport cab", "Car rental", "Mobility as a service", "Public Transportation", "Pickup", "Own car"]
